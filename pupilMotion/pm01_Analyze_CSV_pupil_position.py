...
logging.basicConfig(filename="pm01AnalyzeCSVPupilPosition_" + todays_datetime + ".log", filemode='w', level=logging.INFO)
###################################
# SOURCE DATA AND OUTPUT FILE LOCATIONS 
###################################
pupil_csv_folder, plots_folder, output_folder = load_data()
...
logging.info('DATA FOLDER: %s \n PUPIL PLOTS FOLDER: %s \n ENGAGEMENT PLOTS FOLDER: %s \n LINEAR REGRESSION PLOTS FOLDER: %s \n OUTPUT FOLDER: %s' % (pupil_csv_folder, pupils_folder, engagement_folder, linReg_folder, output_folder))
print('DATA FOLDER: %s \n PUPIL PLOTS FOLDER: %s \n ENGAGEMENT PLOTS FOLDER: %s \n LINEAR REGRESSION PLOTS FOLDER: %s \n OUTPUT FOLDER: %s' % (pupil_csv_folder, pupils_folder, engagement_folder, linReg_folder, output_folder))
###################################
# FIND DAILY PUPIL TRACKING DATA
###################################
daily_folders = glob.glob(data_folder + os.sep + 'SurprisingMinds_*')
